...
function Login() {
  ...
  return (
    <Box padding="2rem">
      ...
      <Paper
        sx={{ maxWidth: "410px", width: "100%", margin: "3rem auto 0 auto" }}
      >
        <Typography variant="h4" padding="1rem 1.5rem 0 1.5rem">
          Login
        </Typography>
        <form
          autoComplete="off"
        ...
        <Typography className="text-center pb-2">
          ...
          <Link to="/signin" className="text-[#006097] font-semibold">
            Sign In
          </Link>
        </Typography>
      </Paper>
